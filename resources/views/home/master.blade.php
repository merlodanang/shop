...
<body>
				...
				<div class="row">
					<div class="col-sm-4">
						<div class="logo pull-left">
							<a href="{{route('home')}}"><h1>Jessica Shop's</h1></a>
						</div>
					</div>
					<div class="col-sm-8">
						<div class="shop-menu pull-right">
							<ul class="nav navbar-nav">
								<li><a href="{{route('home.order.index')}}"><i class="fa fa-crosshairs"></i> Checkout</a></li>
								<li><a href="{{route('home.checkout.index')}}"><i class="fa fa-shopping-cart"></i> Cart</a></li>
							</ul>
						</div>
					</div>
				</div>
	...
	<footer id="footer"><!--Footer-->
		...
		<div class="footer-bottom">
			<div class="container">
				<div class="row">
					<p class="pull-left"><i class="fa fa-phone"></i> +2 95 01 88 821</p>
					<p class="pull-right"><span>Copyright © jesseca Tang Thi</span></p>
				</div>
			</div>
		</div>
